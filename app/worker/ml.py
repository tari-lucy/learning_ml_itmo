...
- В транскрипте идентификаторы спикеров имеют формат SPEAKER_00, SPEAKER_01 и т.д. Используй их в этом ТОЧНОМ виде (не сокращай и не меняй), чтобы потом можно было заменить на реальные имена
...
- В транскрипте идентификаторы спикеров имеют формат SPEAKER_00, SPEAKER_01 и т.д. Используй их в этом ТОЧНОМ виде при указании авторства реплик (не сокращай и не меняй), чтобы потом можно было заменить на реальные имена
